...
public final class HighscorePlayer implements Comparable<HighscorePlayer> {
    ...
    /**
     * Depends on the context, as an example if your looking for a player, in
     * the list When it's sorted for you. You get, if the currentObject is an
     * interest to you
     *
     * @return
     */
    ...
    /**
     * Depends on the context, as an example if your looking for a player, in
     * the list When it's sorted for you. You set if the currentObject is an
     * interest to you
     *
